			...
			>
				...
				<DialogBody>
					...
					<DialogDescription className="text-justify text-sm text-n-700">
						Ao clicar em finalizar as recomendações sugeridas à
						gestante não poderão mais ser alteradas e o resultado
						será protocolado. Confirme os dados antes de continuar.
					</DialogDescription>
				</DialogBody>
