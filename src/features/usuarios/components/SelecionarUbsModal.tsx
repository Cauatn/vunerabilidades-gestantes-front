			...
			>
				...
				<DialogBody className="flex flex-col gap-3 p-7">
					<DialogDescription className="text-left text-sm leading-5 text-n-700">
						Selecione a UBS que você se encontra atualmente. A
						partir desse momento todas operações que você fizer
						estarão associadas a UBS selecionada. Você pode trocar
						de UBS na barra lateral do sistema a qualquer momento.
					</DialogDescription>
